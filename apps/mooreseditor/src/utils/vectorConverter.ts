...
export function arrayToVector2(
  arr: Vector2Array | null | undefined,
): Vector2Object {
...
export function vector2ToArray(
  obj: Vector2Object | null | undefined,
): Vector2Array {
  if (!obj) {
    return [0, 0];
  }
...
export function arrayToVector3(
  arr: Vector3Array | null | undefined,
): Vector3Object {
  if (!arr || !Array.isArray(arr)) {
    return { x: 0, y: 0, z: 0 };
  }
...
export function vector3ToArray(
  obj: Vector3Object | null | undefined,
): Vector3Array {
  if (!obj) {
    return [0, 0, 0];
  }
...
export function arrayToVector4(
  arr: Vector4Array | null | undefined,
): Vector4Object {
  if (!arr || !Array.isArray(arr)) {
...
export function vector4ToArray(
  obj: Vector4Object | null | undefined,
): Vector4Array {
  if (!obj) {
    return [0, 0, 0, 0];
  }
