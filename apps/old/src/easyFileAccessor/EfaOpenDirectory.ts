...
export async function createDirectory(
  ...
  parentPath: string,
  parentDirectory?: EfaDirectoryHandle
): Promise<EfaDirectoryHandle> {
...
export async function efaOpenDirectory(
  id = '',
  mode: OpenDirectoryMode = 'readwrite',
  defaultDirectory: OpenDefaultDirectory = ''
): Promise<EfaDirectoryHandle> {
  //TODO 改善求む
