...
export default class Mod {
  ...
  get machineRecipeConfig() : MachineRecipeConfig {return this._machineRecipeConfig;}

  constructor(meta: ModMeta,itemConfig : ItemConfig,blockConfig : BlockConfig,craftConfig : CraftRecipeConfig,machineRecipeConfig : MachineRecipeConfig) {
    this._meta = meta;
