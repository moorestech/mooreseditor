...
describe('vectorConverter', () => {
  ...
  describe('arrayToVector3', () => {
    it('should convert valid array to Vector3Object', () => {
      ...
      expect(arrayToVector3([-1.5, 3.14, 2.71])).toEqual({ x: -1.5, y: 3.14, z: 2.71 })
    })
  ...
  describe('vector3ToArray', () => {
    it('should convert Vector3Object to array', () => {
      ...
      expect(vector3ToArray({ x: -1.5, y: 3.14, z: 2.71 })).toEqual([-1.5, 3.14, 2.71])
    })
  ...
  describe('arrayToVector4', () => {
    it('should convert valid array to Vector4Object', () => {
      ...
      expect(arrayToVector4([-1.5, 3.14, 2.71, 1.41])).toEqual({ x: -1.5, y: 3.14, z: 2.71, w: 1.41 })
    })
    ...
    it('should handle arrays with missing values', () => {
      expect(arrayToVector4([1, 2, 3] as any)).toEqual({ x: 1, y: 2, z: 3, w: 0 })
  ...
  describe('vector4ToArray', () => {
    it('should convert Vector4Object to array', () => {
      ...
      expect(vector4ToArray({ x: -1.5, y: 3.14, z: 2.71, w: 1.41 })).toEqual([-1.5, 3.14, 2.71, 1.41])
    })
  ...
  describe('special numeric values', () => {
    it('should handle special values in arrayToVector functions', () => {
      expect(arrayToVector2([Infinity, -Infinity])).toEqual({ x: Infinity, y: -Infinity })
      expect(arrayToVector3([NaN, NaN, NaN])).toEqual({ x: NaN, y: NaN, z: NaN })
      expect(arrayToVector4([0, -0, Infinity, -Infinity])).toEqual({ x: 0, y: -0, z: Infinity, w: -Infinity })
    })

    it('should handle special values in vectorToArray functions', () => {
      expect(vector2ToArray({ x: Infinity, y: -Infinity })).toEqual([Infinity, -Infinity])
      expect(vector3ToArray({ x: NaN, y: NaN, z: NaN })).toEqual([NaN, NaN, NaN])
      expect(vector4ToArray({ x: 0, y: -0, z: Infinity, w: -Infinity })).toEqual([0, -0, Infinity, -Infinity])
    })
  })
})