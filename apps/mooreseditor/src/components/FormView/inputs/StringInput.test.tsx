...
describe("StringInput", () => {
  ...
  it("should render textarea for long default values", () => {
    const longDefaultSchema = {
      ...
      default:
        "This is a very long default value that is more than 50 characters long and should trigger textarea rendering",
    };
  ...
  it("should handle very long strings", async () => {
    ...
    render(
      <StringInput {...defaultProps} value={longString} onChange={onChange} />,
    );
  ...
  it("should update local value when prop changes", () => {
    const { rerender } = render(
      <StringInput {...defaultProps} value="initial" />,
    );
