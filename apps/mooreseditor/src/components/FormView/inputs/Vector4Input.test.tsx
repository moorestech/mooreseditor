...
describe("Vector4Input", () => {
  ...
  it("should handle array with more than four values", () => {
    render(
      <Vector4Input {...defaultProps} value={[1, 2, 3, 4, 5, 6] as any} />,
    );
  ...
  it("should handle very large numbers", () => {
    const onChange = vi.fn();
    const largeVector: [number, number, number, number] = [
      1e10, -1e10, 1e15, -1e15,
    ];
    render(
      <Vector4Input
  ...
  it("should handle normalized vectors", () => {
    const normalizedVector: [number, number, number, number] = [
      0.5, 0.5, 0.5, 0.5,
  ...
  it("should handle string values in array gracefully", () => {
    render(
      <Vector4Input {...defaultProps} value={["1", "2", "3", "4"] as any} />,
    );
