/**
 * Schema definitions map: schema ID → schema definition.
 * Re-declared here to keep domain layer free of React hook dependencies.
 */
...
/**
 * Standalone convenience function: resolve all $ref references in a schema.
 */
