...
const EditableTextField =  (props: { fieldValue : string}) => {
  ...
  return (
    <p ref={editNameRef}>
      {
        isEdit ?
        <TextField fullWidth label='Name' placeholder='Item Name' size={"small"} defaultValue={props.fieldValue} autoFocus={true} onFocus={e => e.target.select()}/> :
