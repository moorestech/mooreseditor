  ...
  return (
    <Table>
      ...
      <Table.Tbody>
        ...
        <SchemaRow schema={schema.items} isNew value={newRow} onSave={setNewRow} onAdd={() => {
          const autoGenerated = Object.keys(schema.items.properties).map((propName: string) => {
            const prop = getPropSchema(schema.items, propName, newRow)
            if(prop && prop.type === 'string' && prop.autoGenerated){
              switch(prop.format){
                case 'uuid':
          ...
          onSave([
            ...
            {
              ...newRow,
              ...Object.fromEntries(autoGenerated)
            }
          ])
          setNewRow({})
        }} />
