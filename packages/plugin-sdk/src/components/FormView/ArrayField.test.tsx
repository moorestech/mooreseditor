...
import type { Schema, ArraySchema } from "../../schema";
...
// Mock calculateAutoIncrement at the module useArrayDataManager actually imports from
...
describe("ArrayField", () => {
  ...
  it("should maintain order when updating items", () => {
    ...
    render(
      <ArrayField {...defaultProps} data={data} onDataChange={onDataChange} />,
    );
