...
const CraftRecipeEditModal = (props: {
  isOpen: boolean
  recipe: CraftRecipe
  items: ReadonlyArray<Item>
  onClose: () => void
  onSubmit: (recipe: CraftRecipe) => void
}) => {
  ...
  const resultItemImageUrl =
    ItemConfigUtil.GetItem(resultItemName, recipe.ResultItem.ItemModId ?? '', items)?.imageUrl ?? NoneItemIconUrl
  ...
  return (
    ...
    >
      <DialogContent sx={{ px: 15, py: 15, pt: 8 }}>
        ...
        <Grid item xs={12} spacing={6} mt={15}>
          ...
          <Grid container mb={5} spacing={6} justifyContent={'center'}>
            <ItemCard
              itemName={itemRecipeData[0].itemName}
              url={itemRecipeData[0].itemUrl}
              onClick={() => {
                setRecipeEditingItemIndex(0)
              }}
            ></ItemCard>
            <TextField
              value={itemRecipeData[0].count}
              onChange={v => {
                changeRecipeItemCount(0, parseInt(v.target.value))
              }}
              label='Count'
              type={'number'}
              variant='outlined'
            ...
            <ItemCard
              itemName={itemRecipeData[1].itemName}
              url={itemRecipeData[1].itemUrl}
              onClick={() => {
                setRecipeEditingItemIndex(1)
              }}
            ></ItemCard>
            <TextField
              value={itemRecipeData[1].count}
              onChange={v => {
                changeRecipeItemCount(1, parseInt(v.target.value))
              }}
              label='Count'
              type={'number'}
              variant='outlined'
            ...
            <ItemCard
              itemName={itemRecipeData[2].itemName}
              url={itemRecipeData[2].itemUrl}
              onClick={() => {
                setRecipeEditingItemIndex(2)
              }}
            ></ItemCard>
            <TextField
              value={itemRecipeData[2].count}
              onChange={v => {
                changeRecipeItemCount(2, parseInt(v.target.value))
              }}
              label='Count'
              type={'number'}
              variant='outlined'
          ...
          <Grid container mb={5} spacing={6} justifyContent={'center'}>
            <ItemCard
              itemName={itemRecipeData[3].itemName}
              url={itemRecipeData[3].itemUrl}
              onClick={() => {
                setRecipeEditingItemIndex(3)
              }}
            ></ItemCard>
            <TextField
              value={itemRecipeData[3].count}
              onChange={v => {
                changeRecipeItemCount(3, parseInt(v.target.value))
              }}
              label='Count'
              type={'number'}
              variant='outlined'
            ...
            <ItemCard
              itemName={itemRecipeData[4].itemName}
              url={itemRecipeData[4].itemUrl}
              onClick={() => {
                setRecipeEditingItemIndex(4)
              }}
            ></ItemCard>
            <TextField
              value={itemRecipeData[4].count}
              onChange={v => {
                changeRecipeItemCount(4, parseInt(v.target.value))
              }}
              label='Count'
              type={'number'}
              variant='outlined'
            ...
            <ItemCard
              itemName={itemRecipeData[5].itemName}
              url={itemRecipeData[5].itemUrl}
              onClick={() => {
                setRecipeEditingItemIndex(5)
              }}
            ></ItemCard>
            <TextField
              value={itemRecipeData[5].count}
              onChange={v => {
                changeRecipeItemCount(5, parseInt(v.target.value))
              }}
              label='Count'
              type={'number'}
              variant='outlined'
          ...
          <Grid container mb={5} spacing={6} justifyContent={'center'}>
            <ItemCard
              itemName={itemRecipeData[6].itemName}
              url={itemRecipeData[6].itemUrl}
              onClick={() => {
                setRecipeEditingItemIndex(6)
              }}
            ></ItemCard>
            <TextField
              value={itemRecipeData[6].count}
              onChange={v => {
                changeRecipeItemCount(6, parseInt(v.target.value))
              }}
              label='Count'
              type={'number'}
              variant='outlined'
            ...
            <ItemCard
              itemName={itemRecipeData[7].itemName}
              url={itemRecipeData[7].itemUrl}
              onClick={() => {
                setRecipeEditingItemIndex(7)
              }}
            ></ItemCard>
            <TextField
              value={itemRecipeData[7].count}
              onChange={v => {
                changeRecipeItemCount(7, parseInt(v.target.value))
              }}
              label='Count'
              type={'number'}
              variant='outlined'
            ...
            <ItemCard
              itemName={itemRecipeData[8].itemName}
              url={itemRecipeData[8].itemUrl}
              onClick={() => {
                setRecipeEditingItemIndex(8)
              }}
            ></ItemCard>
            <TextField
              value={itemRecipeData[8].count}
              onChange={v => {
                changeRecipeItemCount(8, parseInt(v.target.value))
              }}
              label='Count'
              type={'number'}
              variant='outlined'
        ...
        <Grid item xs={12} spacing={6} mt={15}>
          <Grid container mb={5} spacing={6} justifyContent={'center'}>
            <ItemCard
              ...
              url={resultItemImageUrl}
              onClick={() => {
                setIsResultItemEditing(true)
              }}
            ></ItemCard>
            <TextField
              value={resultItemCount}
              onChange={v => {
        ...
        {/*  レシピのアイテム選択モーダル */}
        <SelectItemModal
          isOpen={recipeEditingItemIndex != closeStateEditModalIndex}
          onClose={() => {
      ...
      <DialogActions sx={{ justifyContent: 'center', pb: 8 }}>
        <Button
          disabled={recipe.ResultItem.Count <= 0 || recipe.ResultItem.ItemName === undefined}
          variant='contained'
          sx={{ mr: 1 }}
          onClick={() => {
            props.onClose()
